...
`git clone https://github.com/tagirov/kakoune-ladies-night-theme`<br />

`mkdir -p ~/.config/kak/colors/ && mv ./kakoune-ladies-night-theme/ladies-night.kak ~/.config/kak/colors/`<br />
